...
import Logo from '../../static/images/logo/logo-s.png';
                    ...
                    <Row>
                        ...
                        <Col md={3} style={{
                            ...
                            <a href={"https://github.com/SynestiaOS/SynestiaOS"} style={{color: '#000'}}>
                                ...
                                <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                                    <h4>{this.props.t("Repos")}</h4>
                                </Col>
                            </a>
                        </Col>
                        <Col md={3}
                             style={{textAlign: 'center', background: '#fff', height: '15em', paddingTop: '2em', borderBottom: 'solid 1px #eee'}}>

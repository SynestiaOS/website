...
class Docs extends Component {
    ...
    render() {
        return (<Container className="Docs">
            ...
            <Row style={{background: '#f5f5f6', padding: 0, paddingBottom: '3em', paddingTop: '2em'}}>
                <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                    <h1>Let's build it ></h1>
                </Col>
                <Col md={3} style={{textAlign: 'center'}}>
                    <Link to={"/faq"} style={{color: '#000'}}>
                        <Row style={{background: '#fff', height: '15em', textAlign: 'center'}}>
                            <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                                <img style={{top: "0px", width: "171.246px", height: "171px", position: "relative"}}
                                     alt="FAQ"
                ...
                <Col md={3} style={{textAlign: 'center'}}>
                    <Row style={{background: '#fff', height: '15em', textAlign: 'center'}}>
                        <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                            <img style={{width: "171.246px", height: "171px", position: "relative"}}
                                 alt="Forum"
                        ...
                        <a href={"https://github.com/SynestiaOS/Documentation"} style={{color: '#000'}}>
                            <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                                <img className="thumb-image loaded"
                                     style={{width: "171.246px", height: "171px", position: "relative"}}
                                     alt="Docs"
                ...
                <Col md={3} style={{textAlign: 'center'}}>
                    <Row style={{background: '#fff', height: '15em', textAlign: 'center'}}>
                        <Link to={"/blog"} style={{color: '#000'}}>
                            <Col md={12} style={{marginLeft: 'auto', marginRight: 'auto'}}>
                                <img className="thumb-image loaded"
                                     style={{width: "211.246px", height: "171px", position: "relative"}}
                                     alt="News"
